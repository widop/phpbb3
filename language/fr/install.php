...
*
* @package language
* @version $Id: install.php, v1.26 13:53 10:25 14/06/2011 Lolovoisin Exp $
...
$lang = array_merge($lang, array(
   ...
   <p>Seules ces bases de données, si elles sont supportées par votre serveur, seront affichées.',
	...
	'INST_ERR_DB_INVALID_PREFIX'=> 'Le préfixe que vous avez entré n’est pas valide. Il doit commencer par une lettre et ne doit contenir que des lettres, des nombres et des tirets bas.',
	...
	'PHP_SETTINGS_EXPLAIN'   			=> '<strong>Requis</strong> - Vous devez utiliser au moins la version 5.2.0 de PHP pour installer phpBB. Si <var>safe mode</var> est affiché, PHP fonctionne dans ce mode. Cela implique des limitations sur l’administration distante et des fonctionnalités similaires.',
	...
	'PHP_VERSION_REQD'   				=> 'Votre version de PHP doit être la 5.2.0	au minimum',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'=> 'Les tables de la base de données utilisées par phpBB 3.0 ont été créées et remplies avec quelques données initiales. Rendez-vous sur la page suivante pour terminer l’installation de phpBB.',
